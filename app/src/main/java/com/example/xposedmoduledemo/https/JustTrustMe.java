package com.example.xposedmoduledemo.https;
...
public class JustTrustMe implements IXposedHookLoadPackage {
    ...
    public void handleLoadPackage(final LoadPackageParam lpparam) throws Throwable {
        ...
        //主要是设置信任所有的SSLSocketFactory和HostnameVerifier
        ...
        //设置NetworkSecurityTrustManager类中checkPins方法DO_NOTHING
        ...
        //hook noProxy
        findAndHookMethod("java.net.URL", lpparam.classLoader, "openConnection",
                Proxy.class, new XC_MethodReplacement() {
                    @Override
                    protected Object replaceHookedMethod(MethodHookParam param) throws Throwable {
                        return callMethod(param.thisObject, "openConnection");
                    }
                });
        //hook proxy
        findAndHookMethod("java.lang.System", lpparam.classLoader, "getProperty",
                String.class, new XC_MethodHook() {
                    ...
                    protected void afterHookedMethod(MethodHookParam param) throws Throwable {
                        ...
                        if ("http.proxyHost".equals(arg) || ("http.proxyPort".equals(arg))) {
                            param.setResult("");
                        }
                    }
                });
